...
begin
  ...
  begin
    ...
    begin
      PlayObject.SysMsg('技能冷却中，请稍后再试!', 0);
      Exit;
    end;
  end;
  // 检查单个技能GCD
